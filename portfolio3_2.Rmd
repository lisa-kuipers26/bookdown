...
Uiteindelijk heb ik gekozen voor het onderzoek van @zhaoNaturalKillerCell2020. Hoewel het uiteindelijk lukte door mijn RAM te vergroten met `memory.limit(size = 40000)` duurde het heel lang voordat een grafiek gegenereerd kon worden. 

De workflow maakte gebruik van de HDCytoData package om bestanden op te halen, maar de bestanden in deze package hebben de metadata en panel data op https://flowrepository.org/ staan en deze website op het moment van het schrijven van dit script niet bereikbaar.
